...
Il est possible d'utiliser {\color{blue}\textbf{le mot}} clé {\texttt cite} pour citer des références
bibliographiques.  

Un premier exemple de \cite{akgu07},\cite{akgu091}\cite{zwic00} \ldots

Il est possible à l'aide de la commande {\texttt \\url{}} d'insérer un
hyperlien, par exemple : \url{http://en.wikibooks.org/wiki/LaTeX/Command_Glossary}

\section{État de l'Art} 
{\tiny tiny \small small \large large \Large Large \Huge Huge Toi Même}
{\textit
