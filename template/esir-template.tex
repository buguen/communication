...
\title{Mesure du retrait d'une résine chocolatée et nougat}
\author{Bernard Uguen, Anthony Billard} 
...
\PARstart{G}{e} LaTex est basé sur l'idée que les auteurs doivent pouvoir se concentrer sur le contenu de leur écrit sans être distraits par l'aspect visuel du document. 
...
\begin{figure}[htpb]
  \begin{center}
    ...
    \includegraphics[width=\columnwidth]{fondforme.jpg}
  \end{center}
